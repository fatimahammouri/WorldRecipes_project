...
Nav, Media, Row, Col, Modal, Alert, Toast, CardGroup, Spinner, ListGroup, ListGroupItem, Jumbotron} = ReactBootstrap;
        ...
        <div id="main-homepage">
            ...
            <video  autoPlay loop muted preload="auto">
                <source src="/static/images/video.mp4" type="video/mp4"  ></source>
                    the browse do not support videos
            </video>
...
function AboutMe(props){
    return(
       <Container   flex style={{marginTop: "5em"}}>
            <Card className="text-center" style={{ width:'25%', margin:"auto", color:"#dddddd"}}>
                <Card.Img variant="top" src="/static/images/me.jpeg"/>
                <Card.Body>
                <Card.Title>
                Fatima Alhammouri
                </Card.Title>
                <Card.Text> Full Stack Developer / Relationship Banker
                     <br/> I enjoy learning new thing, watching Disney's animated Movies and Solving puzzles 
                    </Card.Text>
                <ListGroup>
                    <ListGroup.Item style={{padding: "0 0 0 0", justifyContent:"center"}}> 
                        <svg  style={{marginRight:"20px", marginLeft:"6px"}} aria-hidden="true" class="octicon octicon-mark-github" height="40" version="1.1" viewBox="0 0 16 16" width="40">
                        ...
                        style={{ color :"#dddddd"}}> github.com/fatimahammouri</a>
                    </ListGroup.Item>
                    <ListGroup.Item style={{padding: "0 0 0 0"}}>
                        <svg   style={{marginRight:"20px", marginLeft:"6px"}}  version="1.1" id="Capa_1" x="0px" y="0px" width="40" height="40" viewBox="0 0 438.536 438.536" >
                       ...
                       href="https://www.linkedin.com/in/fatimaalhammouri/">linkedin.com/in/fatimaalhammouri</a>
                    </ListGroup.Item>
                    <ListGroup.Item style={{padding: "0 0 0 0"}}>
                        
                        <svg style={{marginRight:"20px", marginLeft:"6px"}}  id="Bold" enableBackground="new 0 0 24 24" height="40" viewBox="0 0 24 24" width="40">
                        <path d="m21.534 7.113c.976-.693 1.797-1.558 2.466-2.554v-.001c-.893.391-1.843.651-2.835.777 1.02-.609 1.799-1.566 2.165-2.719-.951.567-2.001.967-3.12 1.191-.903-.962-2.19-1.557-3.594-1.557-2.724 0-4.917 2.211-4.917 4.921 0 .39.033.765.114 1.122-4.09-.2-7.71-2.16-10.142-5.147-.424.737-.674 1.58-.674 2.487 0 1.704.877 3.214 2.186 4.089-.791-.015-1.566-.245-2.223-.606v.054c0 2.391 1.705 4.377 3.942 4.835-.401.11-.837.162-1.29.162-.315 0-.633-.018-.931-.084.637 1.948 2.447 3.381 4.597 3.428-1.674 1.309-3.8 2.098-6.101 2.098-.403 0-.79-.018-1.177-.067 2.18 1.405 4.762 2.208 7.548 2.208 8.683 0 14.342-7.244 13.986-14.637z"/></svg>
                        <a style={{ color :"#dddddd"}}
                        href="https://twitter.com/FatimaHammouri" rel="nofollow noopener" target="_blank">twitter.com/FatimaHammouri</a>
                    </ListGroup.Item>
                </ListGroup>
                </Card.Body>
