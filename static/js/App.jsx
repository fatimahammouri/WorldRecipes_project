    ...
    return(
        <div>
            <div className="welcome-text" >
                ...
                <h3>Follow me on Twitter        Check My GitHub Accout        Connect with me on LinkedIn </h3> 
                </Nav>

                <Nav>
                
                    <Nav.Link href="https://twitter.com/FatimaHammouri" className="footer-icons"
                ...
                <Nav.Link href="https://github.com/fatimahammouri"  title="GitHub" className="footer-icons">
                ...
                <Nav.Link href="https://www.linkedin.com/in/fatimaalhammouri/" className="footer-icons">
