    ...
    return(
       <Container   flex style={{marginTop: "5em"}}>
            <Card className="text-center" style={{ width:'25%', margin:"auto", color:"#dddddd"}}>
                ...
                <Card.Text> Full Stack Developer <br/> Relationship Banker</Card.Text>
                <ListGroup>
                    <ListGroup.Item style={{padding: "0 0 0 0", justifyContent:"center"}}> 
                        ...
                        style={{ color :"#dddddd"}}> fatimahammouri</a>
                    </ListGroup.Item>
                    <ListGroup.Item style={{padding: "0 0 0 0"}}>
                       ...
                       href="https://www.linkedin.com/in/fatimaalhammouri/">fatimaalhammouri</a>
                    </ListGroup.Item>
                    <ListGroup.Item style={{padding: "0 0 0 0"}}>
                        ...
                        <a style={{ color :"#dddddd"}}
                        href="https://twitter.com/FatimaHammouri" rel="nofollow noopener" target="_blank">FatimaHammouri</a>
                    </ListGroup.Item>
                </ListGroup>
                </Card.Body>
